...
class InterestTypeANotifier extends StateNotifier<List<double>> {
  InterestTypeANotifier() : super([]);
...
final interestTypeAProvider =
    StateNotifierProvider.autoDispose<InterestTypeANotifier, List<double>>(
        (ref) {
  return InterestTypeANotifier();
});
